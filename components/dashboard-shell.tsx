...
export function DashboardShell({ children, name, image, role }: DashboardShellProps) {
  ...
  return (
    <div className="min-h-screen bg-muted/20 flex flex-col md:flex-row">
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex md:w-64 md:flex-col border-r bg-card px-4 py-6 shrink-0 sticky top-0 h-screen overflow-y-auto">
        ...
        {/* Added mt-auto to push this entire section strictly to the bottom of the fixed sidebar */}
        <div className="mt-auto border-t pt-4 px-2 space-y-3">
